...
function svgDrawProsharp3D(x, y) {
    /* Template dimensions */
...
function svgDrawBlade(x, y, bladeString) {
...
//    svgDrawText(   xCenter,         28, "1.5mm", document.getElementById("fingerprint").value);
    ...
    svgDrawBlade(xCenter, 5.0, bladeString);
    templateSvg.innerHTML = svgContent;
}
