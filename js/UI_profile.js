...
function svgDrawOutlineDataPointsTxt(x, y) {
    /* Template dimensions */
...
function svgDrawProsharp3DOutline(x, y) {
    /* Template dimensions */
...
function svgDrawProsharpOutline(x, y) {
    /* Template dimensions */
    const templateWidth         = 400;
    const templateHeightMin     = 20;
    const templateHeightMax     = 32;
...
function svgDrawEliteOutline(x, y) {
...
function svgDrawBladeOutline(x, y, bladeString) {
...
function uiRedrawDataPointsTxt(xCenter, yCenter) {
    ...
    svgDrawProsharpOutline(xCenter, 5.0);
...
function uiRedrawProsharp3DTemplate(xCenter, yCenter) {
    ...
    svgDrawProsharp3DOutline(xCenter, 5.0);
    templateSvg.innerHTML = svgContent;
}
...
function uiRedrawEliteTemplate(xCenter, yCenter) {
    ...
    svgDrawEliteOutline(xCenter, 5.0);
    templateSvg.innerHTML = svgContent;
}
...
//    svgDrawText(   xCenter,         28, "1.5mm", document.getElementById("fingerprint").value);
    ...
    svgDrawBladeOutline(xCenter, 5.0, bladeString);
    templateSvg.innerHTML = svgContent;
}

function uiRedrawTemplate() {
